...
For the demo I have already set up a simple repository on Github with create-react-app.
...
> Send link to slack channel at this time

It would be great if you could take out your laptops. Open the link:

- Fork the project
- Clone it
- Create and checkout to a branch: `git checkout -b demo`
- Do `npm i` or `yarn`
...
The presentation is also in the same repo as the one you used for the Demo. Feel free to check it out and suggest any changes.
